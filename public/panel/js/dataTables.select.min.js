...
(function (f) {
    ...
    function A(a) {
        ...
        b.on("mousedown.dtSelect", d, function (a) {
            ...
            .on("click.dtSelect", d, function (c) {
                ...
                if (e) {
                    ...
                    if (
                        (!d.anchorNode ||
                            f(d.anchorNode).closest("table")[0] ===
                                a.table().node()) &&
                        d !== e
                    )
                        return;
                ...
                d = a.settings()[0];
                var l = f
                    .trim(a.settings()[0].oClasses.sWrapper)
                    .replace(/ +/g, ".");
                if (
                    f(c.target).closest("div." + l)[0] ==
                        a.table().container() &&
                    ((l = a.cell(f(c.target).closest("td, th"))), l.any())
                ) {
        ...
        f("body").on(
            ...
            function (b) {
                !c._select.blurable ||
                    f(b.target).parents().filter(a.table().container())
                        .length ||
    ...
    function B(a) {
        ...
        if (b._select.info && b.aanFeatures.i && "api" !== a.select.style()) {
            var c = a.rows({ selected: !0 }).flatten().length,
                ...
                l = function (b, c, d) {
                    b.append(
                        f('<span class="select-item"/>').append(
                            a.i18n(
                                "select." + c + "s",
                                {
                                    _: "%d " + c + "s selected",
        ...
        a.aoRowCreatedCallback.push({
            fn: function (b, d, e) {
                ...
                for (e = a.aoColumns.length; b < e; b++)
                    (a.aoColumns[b]._select_selected ||
                        (d._selected_cells && d._selected_cells[b])) &&
                        f(d.anCells[b]).addClass(a._select.className);
            },
    ...
    function C(a, b, c, d) {
        ...
        a[b](c, { selected: !0 }).any()
            ? (e.splice(f.inArray(c, e), 1), a[b + "s"](e).deselect())
            : a[b + "s"](e).select();
    }
    function r(a, b) {
                ...
                ? a.ctrlKey || a.metaKey
                    ...
                    ? "cell" === d
                        ...
                        : C(
                              ...
                              d,
                              e,
                              c._select_lastCell ? c._select_lastCell[d] : null
                          )
                    : ((a = b[d + "s"]({ selected: !0 })),
                      h && 1 === a.flatten().length
                          ? b[d](e).deselect()
    ...
    function E(a, b) {
        return (-1 !== f.inArray("rows", b.limitTo) &&
            a.rows({ selected: !0 }).any()) ||
            (-1 !== f.inArray("columns", b.limitTo) &&
                a.columns({ selected: !0 }).any()) ||
            (-1 !== f.inArray("cells", b.limitTo) &&
                a.cells({ selected: !0 }).any())
            ? !0
            : !1;
    }
            ...
            return this.api()
                ...
                .map(function (a) {
                    return "row" === b._select.items
                        ? f(a).parent().hasClass(b._select.className)
                        : "cell" === b._select.items
                        ? f(a).hasClass(b._select.className)
                        : !1;
                });
        };
        !n &&
            f(a.table().node()).hasClass("selectable") &&
            a.select.style("os");
    };
    f.each(
        [
    ...
    g.ext.selector.cell.push(function (a, b, c) {
        ...
        for (var e = 0, f = c.length; e < f; e++) {
            ...
            ((!0 === b &&
                g._selected_cells &&
                !0 === g._selected_cells[c[e].column]) ||
                !(
                    !1 !== b ||
                    (g._selected_cells && g._selected_cells[c[e].column])
                )) &&
                d.push(c[e]);
        }
        return d;
        ...
        this.iterator("column", function (a, c) {
            ...
            b.cells(null, c)
                ...
                .each(function (b) {
                    ...
                    !c.anCells ||
                        (d && d[b.column]) ||
                        f(c.anCells[b.column]).removeClass(a._select.className);
                });
        });
        this.iterator("table", function (b, c) {
    ...
    q("cells().deselect()", "cell().deselect()", function () {
        ...
        this.iterator("cell", function (a, c, d) {
            ...
            c.anCells &&
                !a.aoColumns[d]._select_selected &&
                f(c.anCells[d]).removeClass(a._select.className);
        });
        this.iterator("table", function (b, c) {
