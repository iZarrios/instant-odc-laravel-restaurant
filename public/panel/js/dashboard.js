    ...
    $(function () {
        if ($("#performaneLine").length) {
            ...
            var graphGradient2 = document
                .getElementById("performaneLine")
                .getContext("2d");
            var saleGradientBg = graphGradient.createLinearGradient(
                5,
                0,
                5,
                100
                ...
                datasets: [
                    {
                        label: "This week",
                        data: [
                            50, 110, 60, 290, 200, 115, 130, 170, 90, 210, 240,
                            280, 200,
                        ],
                    ...
                    },
                    {
                        label: "Last week",
                        data: [
                            30, 150, 190, 250, 120, 150, 130, 20, 30, 15, 40,
                            95, 180,
                        ],
                ...
                datasets: [
                    {
                        label: "Last week",
                        data: [
                            110, 220, 200, 190, 220, 110, 210, 110, 205, 202,
                            201, 150,
                        ],
                    ...
                    },
                    {
                        label: "This week",
                        data: [
                            215, 290, 210, 250, 290, 230, 290, 210, 280, 220,
                            190, 300,
                        ],
